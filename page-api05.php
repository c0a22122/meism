...
$channel_ids_to_process = array_slice($channel_ids, 200, 50);
...
if (!empty($live_streams)) {
    echo "page-api05: 実行成功 - " . count($live_streams) . " 件のライブストリームを取得しました。";
} else {
    echo "page-api05: 実行成功 - 取得したライブストリームはありませんでした。";
}
